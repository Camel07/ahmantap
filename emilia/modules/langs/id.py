...
# Help modules
	"language_help": """Tidak semua grup berbicara bahasa Indonesia; beberapa grup lebih suka Dora menanggapi dalam bahasa mereka sendiri.

Di sinilah terjemahan masuk; Anda dapat mengubah sebagian besar balasan Dora menjadi bahasa pilihan Anda!
