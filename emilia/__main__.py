    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                ...
                [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/hirunayoutube"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/hirunayoutubechannel")],
                [InlineKeyboardButton(text="❓ Help", url="https://t.me/{}?start=help".format(context.bot.username)), InlineKeyboardButton(text="💖 About Developer", url="https://t.me/hirunaofficial")],
